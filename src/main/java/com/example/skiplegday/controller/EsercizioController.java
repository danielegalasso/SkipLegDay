...
import com.example.skiplegday.view.EsercizioGeneraleHandler;
...
public class EsercizioController {
    ...
    public void initialize(){
        EsercizioGeneraleHandler.getInstance().collegaControllerHandlerEsercizio(imageEsercizio,esercizioTextFlow,removeEsercizio);
    }
}
