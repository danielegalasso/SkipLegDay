...
public class Database {
    ...
    public boolean modRecensione(String username, Double valutazione, String recensione) throws SQLException {
        if (this.con != null && !this.con.isClosed()) {
    ...
    public DataUser getAllDataFromUser(String username) throws SQLException {
        ...
        resultSet.close();
        statement.close();
        return new DataUser(username, password, nome, cognome, sesso, peso, dataNascita, altezza, css, valutazione, recensione);
    }
