...
public class HomeController {
    ...
    public void guidaAction(ActionEvent actionEvent) throws IOException {
        SceneSecondaryHandler.getInstance().createGuidaScene();
    }
    ...
    public void settingsButtonAction(ActionEvent actionEvent) {
        ...
        double sceneY = settingsButton.localToScene(settingsButton.getBoundsInLocal()).getMinY() + settingsButton.getHeight();
